...
@s3alex
s3alex Update index.jsp
Latest commit 2b95e6f 10 hours ago
 History
 12 contributors
@kemvoueric@devopseasylearning@CedricKen@leslymegne@s3alex@YvanNys@Galiomid@kmigap@fjen53@barby202@Amy2900@ousmane777
399 lines (327 sloc)  27 KB
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">$10.10</p>
                </a>
            </div>
